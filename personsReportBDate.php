...
<head>
    ...
    <title>Persons Report By Birth Date</title>
...
$bDateFrom = mysqli_real_escape_string($conn,$_POST['bDateFrom']);
$bDateTo = mysqli_real_escape_string($conn,$_POST['bDateTo']);
$result = mysqli_query($conn,"SELECT * FROM persons where dob>='$bDateFrom' && dob<='$bDateTo'");
